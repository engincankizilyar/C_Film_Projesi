...
int main()
{
	...
	else if(secim==2)
	{
		...
		while(!feof(fp1)){
		   ...
		   sayac1++;
		   flmsyc++;//flmssayac kadar dongunun donmesi için olusturuldu.
		}
	...
	else if(secim==4)
	{
		...
		yeni2=fopen("filmliste1.txt","w"); //yeni bilgiler bu yeni2'ye yazılacak.
